...
?>
	...
	<div class="vs">	
		...
		<div class="kontent2">
			<form method="post">
				<div class="regr"> <br> 
				<span><p>*-обязательные к заполнению поля</p></span>
				<br><p><b>Фамилия *:</b>
				<input type="text" maxlength="20" required class="reg" size="50" name="_famil" value="<?php if(isset ($_POST['_famil'])) echo $_POST['_famil']?>"/></p><br>
				<p><b>Имя *:</b>
				<input type="text" maxlength="20" required class="reg" size="50" name="_name" value="<?php if(isset ($_POST['_name'])) echo $_POST['_name']?>"/></p><br>
				<p><b>Отчество*:</b>
				<input type="text" maxlength="20" required class="reg" size="50" name="_otch" value="<?php if(isset ($_POST['_otch'])) echo $_POST['_otch']?>"/></p><br>
				<p><b>Логин *:</b>
				<input type="text" maxlength="20" required class="reg" size="50" name="_login" value="<?php if(isset ($_POST['_login'])) echo $_POST['_login']?>"/></p><br>
				<p><b>E-mail *:</b>
				<input type="email" maxlength="20" required class="reg" size="50" name="_email" value="<?php if(isset ($_POST['_email'])) echo $_POST['_email']?>"/></p><br>
				<p><b>Пароль *:</b>
				<input type="password" maxlength="20" required class="reg" size="50" name="_password" /></p><br> 
